...
| Property | Type | Description |
|----------|------|-------------|
| bluesky? | [bluesky](#bluesky) | Bluesky OAuth client configuration. Default: `{"enabled":true,"client_name":"Fluxer","client_uri":"","logo_uri":"https://static.rdchat.ru/web/apple-touch-icon.png","tos_uri":"https://rdchat.ru/terms","policy_uri":"https://rdchat.ru/privacy","keys":[]}` |
...
| Property | Type | Description |
|----------|------|-------------|
| additional_allowed_origins? | array&lt;string&gt; | List of allowed origins for WebAuthn registration/authentication. Default: `["https://web.rdchat.ru","https://web.canary.rdchat.ru"]` |
| rp_id? | string | Relying Party ID (domain) for WebAuthn credentials. Default: `rdchat.ru` |
...
| logo_uri? | string | Optional logo presented during authorization. Default: `https://static.rdchat.ru/web/apple-touch-icon.png` |
| policy_uri? | string | Privacy policy URI exposed to Bluesky. Default: `https://rdchat.ru/privacy` |
| tos_uri? | string | Terms of service URI exposed to Bluesky. Default: `https://rdchat.ru/terms` |
...
```json
{
  ...
  "enabled": true,
  "keys": [],
  "logo_uri": "https://static.rdchat.ru/web/apple-touch-icon.png",
  "policy_uri": "https://rdchat.ru/privacy",
  "tos_uri": "https://rdchat.ru/terms"
}
```
</Expandable>
...
| static_cdn_domain? | string | Separate domain for static CDN assets (optional). Default: `static.rdchat.ru` |
...
```json
{
  ...
  "public_port": 8088,
  "public_scheme": "http",
  "static_cdn_domain": "static.rdchat.ru"
}
```
</Expandable>
