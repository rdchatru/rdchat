...
Fluxer's APIs are consistent across Fluxer instances, as long as they're running the latest Fluxer Server version. This applies whether you use the official rdchat.ru deployment operated by Fluxer Platform AB or a self-hosted deployment. Just make sure you use the correct base URLs for the instance you're targeting.
...
<CardGroup cols={2}>
	...
	<Card title="WebSocket Gateway API" icon="satellite-dish" href="/gateway">
	...
	<Card title="Resources" icon="table" href="/resources">
